...
from api.api_views import result_list, result_detail, opening_average_list, opening_average_detail,log_list,log_detail
...
urlpatterns = [
    ...
    path('process_request/',log_detail, name = 'log_detail'),      
]