...
from api.api_views import result_list, result_detail, opening_average_list, opening_average_detail,log_list,log_detail,process_request,covid_prediction
...
urlpatterns = [
    ...
    path('covid_prediction/',covid_prediction, name = 'covid prediction'),         
]