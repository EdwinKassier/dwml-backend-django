...
class TestAPIEndpoints:
    ...
    def test_process_request_invalid_symbol(self):
        ...
        response = self.client.get(
            "/api/v1/calculations/", {"symbol": "INVALID", "investment": "1000"}
        )
    ...
    def test_process_request_missing_investment(self):
        ...
        response = self.client.get("/api/v1/calculations/", {"symbol": "BTC"})
    ...
    def test_process_request_missing_symbol(self):
        ...
        response = self.client.get("/api/v1/calculations/", {"investment": "1000"})
        assert response.status_code == 400
        data = response.json()
        assert "error" in data
    ...
    def test_process_request_valid_parameters(self):
        ...
        response = self.client.get(
            "/api/v1/calculations/", {"symbol": "ETH", "investment": "5000"}
        )
